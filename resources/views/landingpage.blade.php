...
<head>
    ...
    <link rel="shortcut icon" href=".\img\logo.gif" type="image/gif" />
    <link rel="Bookmark" href=".\img\logo.gif" type="image/gif" />
...
<body id="page-top" class="index">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                <a class="navbar-brand" href="#page-top">L.F. Doctor</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="#themes">作品主題</a>
                    </li>
                    <li class="page-scroll">
                        <a href="#featured">作品特色</a>
                    </li>
                    <li class="page-scroll">
                        <a href="#content">作品介紹</a>
                    </li>
                    <li class="page-scroll">
                        <a href="#group">創作團隊</a>
                    </li>
    ...
    <header>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <!--<img class="img-responsive" src="img/logo.gif" alt="">-->
                    <div class="intro-text">
                        <span class="name">L.F. Doctor</span>
                        <hr class="star-light">
                        <span class="skills">Quick , Easy , Convenient and Information Transparent.</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2">
                    <h4>診所查詢</h4>
                    <p>相較於一般的地址、時間或診科別查詢，較為特殊的功能為查詢結果除了可以觀看診所基本資料，更可以觀看診所歷年處分紀錄。</p>
                </div>
                <div class="col-lg-4">
                    <h4>藥單查詢</h4>
                    <p>診所同步資料到本系統後，經過輸入健保卡卡號即可查詢診所開的個人藥單，並可在藥單中查看各種藥品的作用及副作用。</p>
                </div>
            </div>
        </div>
    </section>
